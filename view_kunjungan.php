...
<body>
   <div class="container">
       ...
       <div class="row">
           <div class="col">
               <a href="tambah_kunjungan.php" class="btn btn-primary btn-sm d-flex justify-content-center">Tambah Data</a>
           </div>
       </div>
       <div class="row mt-3">
           <div class="col">
               <table class="table table-striped table-hover tabel-sm">
                   ...
                   ?>
                       <tr>
                           ...
                           <td><?= $data['tanggal']; ?></td>
                           <td><?= $data['keluhan']; ?></td>
                           <td><a href="edit_kunjungan.php?edit=<?= $data['idKunjungan']; ?>" class="btn btn-warning btn-sm">Edit </a>
                           <a href="koneksi_kunjungan.php?idKunjungan=<?= $row['idKunjungan']; ?>" class="btn btn-danger btn-sm">Hapus</a>
                        </td>
                       </tr>
                   <?php } ?>
               </table>
