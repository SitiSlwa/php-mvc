   ...
   <div class="container">
       <nav class="navbar navbar-expand-lg navbar-light bg-light">
           <div class="container-fluid">
               <a href="dokter.php" class="navbar-brand">My App</a>
       ...
       <div class="row">
           <div class="col">
               <a href="tambah_dokter.php" class="btn btn-primary btn-sm d-flex justify-content-center">Tambah Data Dokter</a>
           </div>
       </div>
       <div class="row mt-3">
           <div class="col">
               <table class="table table-striped table-hover tabel-sm">
                   ...
                   ?>
                       <tr>
                           ...
                           <td><?= $data['noTelp']; ?></td>
                           <td><a href="edit_dokter.php?edit=<?= $data['idDokter']; ?>" class="btn btn-warning btn-sm">Edit Data </a>
                           <a href="koneksi_dokter.php?idDokter=<?= $row['idDokter']; ?>" class="btn btn-danger btn-sm">Hapus </a>
                        </td>
                       </tr>
                   <?php } ?>
               </table>
